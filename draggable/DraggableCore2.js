...
//
// 
// function base_view(component) {
//   return {
//      controller: function(){
//         ga('send', 'pageview', component.gaId);
//         return component.controller ? component.controller.apply(this, arguments) : {};
//      },
//     view: function(){
//         return m('.content', [
//           component.view.apply(this, arguments)
//         ]);
//      }
//   }
// }

var DraggableCore = function (component) {
  const {
